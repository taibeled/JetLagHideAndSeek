    ...
    case 'seven11':
      questionSpecific = (
        <span className="px-2 text-center text-orange-500">
          This question will eliminate hiding zones that don&apos;t fit the
          criteria. When you click on a zone, the parts of that zone that
          don&apos;t satisfy the criteria will be eliminated.
        </span>
      );
      break;
    case 'aquarium':
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectGroup>
              ...
              <SelectItem value="mcdonalds" disabled={!$displayHidingZones}>
                McDonald&apos;s Question
              </SelectItem>
              <SelectItem value="seven11" disabled={!$displayHidingZones}>
                7-Eleven Question
              </SelectItem>
              <SelectItem value="rail-measure" disabled={!$displayHidingZones}>
      ...
      <SidebarMenuItem className={MENU_ITEM_CLASSNAME}>
        ...
        <Checkbox
          ...
          onCheckedChange={(checked) =>
            questionModified((data.hiderCloser = checked as boolean))
          }
        />
      </SidebarMenuItem>
      <SidebarMenuItem
