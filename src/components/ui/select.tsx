...
import { SelectPortalContainerContext } from "@/components/ui/select-portal-host";
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.ScrollUpButton
        ref={ref}
        className={cn(
            "hidden cursor-default items-center justify-center py-1 [@media(pointer:fine)]:flex",
            className,
        )}
        {...props}
    >
...
>(({ className, children, position = "popper", ...props }, ref) => {
    const selectPortalContainer = React.useContext(
        SelectPortalContainerContext,
    );
    return (
        <SelectPrimitive.Portal container={selectPortalContainer ?? undefined}>
            ...
            >
                ...
                <SelectPrimitive.Viewport
                    className={cn(
                        "min-h-0 overflow-y-auto overscroll-y-contain p-1 touch-pan-y",
                        position === "popper" &&
                    ...
                    style={
                        position === "popper"
                            ? {
                                  maxHeight:
                                      "min(24rem, var(--radix-select-content-available-height, 85dvh))",
                                  touchAction: "pan-y",
                              }
                            : undefined
                    }
