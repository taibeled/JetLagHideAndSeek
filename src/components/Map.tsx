      ...
      for (let index = 0; index < $questions.length; index++) {
        ...
        switch (question?.id) {
          case 'radius':
            ...
            mapGeoData = adjustPerRadius(question.data, mapGeoData, false);
            break;
          case 'thermometer':
            mapGeoData = adjustPerThermometer(question.data, mapGeoData, false);
            break;
          case 'tentacles':
      ...
      for (let index = 0; index < $questions.length; index++) {
        ...
        switch (question?.id) {
          case 'radius':
            ...
            mapGeoData = adjustPerRadius(question.data, mapGeoData, true);
